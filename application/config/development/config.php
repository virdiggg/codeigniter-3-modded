...
|
*/
$config['encryption_key'] = 'A40C0ZXZ9TOJU2GI2450WBAMAP0CPV50';
...
$config['sess_cookie_name'] = !is_cli() ? md5($_SERVER['HTTP_USER_AGENT'] . preg_replace("(^https?://)", '', $config['base_url']) . '1') : md5(preg_replace("(^https?://)", '', $config['base_url']) . '1');
